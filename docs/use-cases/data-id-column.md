...
| C08 | AI Agent (A) | Orchestrateur d’agents | Porte l’identité applicative, planifie, appelle LLM, outils et data selon policies. [^18][^19] | LangChain / LangGraph, Semantic Kernel, CrewAI, AutoGen, OpenAI Agents. |
