...
**AWS Agentic AI Security Scoping Matrix** (Preview - detailed in [Security Frameworks](02-security-frameworks.md)):
...
**Next**: [Security Architecture Frameworks](02-security-frameworks.md) - Learn about AWS Agentic AI Security Scoping, AEGIS, OWASP, and McKinsey frameworks.
